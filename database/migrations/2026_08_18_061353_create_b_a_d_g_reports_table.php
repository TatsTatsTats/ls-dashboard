...
return new class extends Migration
{
    ...
    {
        Schema::create('b_a_d_g_reports', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('amount_finance', 15, 2);
            $table->decimal('net_monthly_amortization', 15, 2);
            ...
            $table->string('mother_company_of_dealer')->nullable();
    ...
    {
        Schema::dropIfExists('b_a_d_g_reports');
    }
};
